...
hetero_graph = torch.load(f'processed_data/{GRAPH_NAME}.pt', weights_only=True)
...
# Save
torch.save(hetero_graph, f'processed_data/{GRAPH_NAME}.pt')
print(f"\nSaved to processed_data/{GRAPH_NAME}.pt")
